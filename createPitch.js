unction createPitch() {
    ...
    for (y = 0; y < 15; y++) {
        for (x = 0; x < 26; x++) {
            html = "<div id='ps" + x + "-" + y + "' class='pitch noselect'>" + x + "-" + y + "</div>";
            if (x === 0) html = "<div id='ps" + x + "-" + y + "' class='pitch homeEnd noselect'>" + x + "-" + y + "</div>";
            if (x == 25) html = "<div id='ps" + x + "-" + y + "' class='pitch awayEnd noselect'>" + x + "-" + y + "</div>";
